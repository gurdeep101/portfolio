...
Usage:
  ...
  uv run python scripts/pipeline/update_portfolio.py --decisions data/decisions/YYYY-MM-DD.json --dry-run
  uv run python scripts/pipeline/update_portfolio.py --init   # initialise all-cash portfolio.json
