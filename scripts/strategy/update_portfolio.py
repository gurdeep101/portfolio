...
Usage:
  ...
  uv run python scripts/strategy/update_portfolio.py --decisions data/decisions/YYYY-MM-DD.json --dry-run
  uv run python scripts/strategy/update_portfolio.py --init   # initialise all-cash portfolio.json
...
# Make shared/ importable when running as `uv run python scripts/strategy/update_portfolio.py`
sys.path.insert(0, str(Path(__file__).parent.parent))
from shared.types import DecisionsFile, Portfolio, PortfolioHolding, TransactionLogEntry
