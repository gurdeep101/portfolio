...
WEIGHTS: dict[str, float] = {
    ...
    "quality": 0.30,       # ROE normalised across eligible universe
    "value": 0.30,         # 1/PB normalised across eligible universe
}
...
def compute_rankings(
    ...
    Symbols are excluded from ranking (and cannot be bought) if ROE or PB is
    ...
    # Value: higher 1/PB = cheaper = better rank; replace 0 PB to avoid div/0.
...
def main() -> None:
    ...
    if not rankings.empty:
        ...
        print(tabulate(
            table_data,
            headers=["Rank", "Symbol", "LT Mom", "NT Mom", "Quality", "Value",
                     "Composite", "MA", "Status"],
            tablefmt="simple",
        ))
        print()
