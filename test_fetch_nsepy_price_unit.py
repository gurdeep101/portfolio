...
Run: uv run python test_fetch_nsepy_price_unit.py
"""
...
import scripts.fetch_nsepy_price as fnp
...
with (
    ...
    patch("scripts.fetch_nsepy_price.time.sleep"),
...
with patch("scripts.fetch_nsepy_price.fetch_symbol_nselib", side_effect=_mock_nselib_fetch), \
     patch("scripts.fetch_nsepy_price.time.sleep"):
...
with patch("scripts.fetch_nsepy_price.fetch_symbol_jugaad", side_effect=_mock_jugaad_partial), \
     patch("scripts.fetch_nsepy_price.time.sleep"):
...
with patch("scripts.fetch_nsepy_price.fetch_symbol_jugaad", side_effect=_mock_jugaad_all), \
     patch("scripts.fetch_nsepy_price.time.sleep"):
...
with (
    patch("scripts.fetch_nsepy_price.yf.Ticker", side_effect=_MockTicker),
    patch("scripts.fetch_nsepy_price.time.sleep"),
):
